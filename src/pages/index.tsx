  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vkanban - Streamlining Your Development Tasks. A comprehensive manager for developers and projects, featuring a filterable Kanban board, customizable project and developer pages, and a flexible project tasks page. Experience the ease of drag-and-drop task status updates."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1532622785990-d2c36a76f5a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkZXZlbG9wbWVudHxlbnwwfHx8fDE2OTg4NjU3MDh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@kaleidico?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Kaleidico`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Vkanban - Streamlining Your Development Tasks. A comprehensive manager for developers and projects, featuring a filterable Kanban board, customizable project and developer pages, and a flexible project tasks page. Experience the ease of drag-and-drop task status updates.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Project Manager" type="project-manager" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
